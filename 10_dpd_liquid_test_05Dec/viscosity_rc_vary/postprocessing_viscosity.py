...
x_ave, y_ave = movingaverage(timestep_av_values[0.9], avtemp[0.9])
t_simulation[0.9] = y_ave[-1] * (epsilon/k_b) - 273.15
ax.scatter(t_simulation[0.9], viscosity[0.9])
...
x_ave, y_ave = movingaverage(timestep_av_values[0.6], avtemp[0.6])
t_simulation[0.6] = y_ave[-1] * (epsilon/k_b) - 273.15
ax.scatter(t_simulation[0.6], viscosity[0.6])
