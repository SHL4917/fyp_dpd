...
fig.savefig('lastslice_hist.png', format='png', dpi=1200, 
             bbox_inches='tight')
...
np.save(f"stuck4_{varied}.npy", stuck4)    
np.save(f"stuck5_{varied}.npy", stuck5)  
...
fig.savefig('beads_near_bilayer.png', format='png', dpi=1200, 
             bbox_inches='tight')
...
fig.savefig('frac_beads_near_bilayer.png', format='png', dpi=1200, 
             bbox_inches='tight')