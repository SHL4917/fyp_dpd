...
#%%
values = [15, 40, 70, 100]
filenames_4 = [f"stuck4_$x_4={x}$.npy" for x in values]
filenames_5 = [f"stuck5_$x_4={x}$.npy" for x in values]
...
fig.savefig(f'all_beads_near_bilayer_x4.png', format='png', dpi=1200, bbox_inches='tight')
