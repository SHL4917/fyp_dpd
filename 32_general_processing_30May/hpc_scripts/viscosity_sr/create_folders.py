...
#%%
shear_values = [0.05, 0.1, 0.15, 0.2, 0.3, 0.5]
folder_name = [f"srate_{x * 100:03.0f}" for x in shear_values]

#%%
input_script = []

for i, srate in enumerate(shear_values):
    input_script += [f"""
units		lj
timestep	0.04
comm_modify	vel yes
...
fix		2 all deform 1 xz erate {srate} remap v
