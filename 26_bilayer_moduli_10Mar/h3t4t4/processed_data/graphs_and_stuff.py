...
#fig.savefig(f'pressure_profile_{struct}_stretched_less.png', format='png', dpi=1200, 
            #bbox_inches='tight')
...
fig.savefig('bilayer_density_profile_nice.png', format='png', dpi=1200, 
             bbox_inches='tight')