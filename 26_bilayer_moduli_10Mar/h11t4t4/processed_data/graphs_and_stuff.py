...
poly_count = poly_count[[7, 8, 9, 10, 13, 14, 15, 16]]
...
#fig.savefig(f'pressure_profile_{struct}_squeezed.png', format='png', dpi=1200, 
            #bbox_inches='tight')
...
#fig.savefig('bilayer_density_profile_notsonice3.png', format='png', dpi=1200, 
             #bbox_inches='tight')